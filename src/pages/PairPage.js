...
import { useGetCoinMarketCapData } from "../contexts/TokenData";
...
import BSCScanIcon from "../assets/bscscan.jpg";
...
function PairPage({ pairAddress, history }) {
  ...
  const coinMarketCapData = useGetCoinMarketCapData();
      ...
      <ContentWrapperLarge>
        <WarningGrouping disabled={false}>
          <DashboardWrapper>
                      ...
                      {token0 && token1 ? (
                        <div className="d-flex flex-column">
                          <div className="d-flex">
                            <HoverSpan style={{ fontWeight: 300 }}>
                              {token1.symbol}
                            </HoverSpan>
                            <span>/</span>
                            <HoverSpan style={{ fontWeight: 900 }}>
                              {token0.symbol}
                            </HoverSpan>
                            <LinkWrap>
                              <a href="#">
                          ...
                          <div>
                            <p style={{ fontSize: "1rem", color: "#95A1AF" }}>
                              <span
                                style={{
                                  marginRight: "1rem",
                                  fontSize: "1.15rem",
                              ...
                              Token contract: 0x5095c6...f2b3 <ImCopy />
                              - Pair <ImCopy />
                            </p>
                          </div>
                        </div>
            ...
            >
              <FixedPanel style={{ width: "20%", padding: "10px 40px" }}>
                <RowFixed>
                  <TYPE.main
                    fontSize={"16px"}
                    lineHeight={1}
